...
var _todo_list_container = __webpack_require__(157);
...
window.allTodos = (0, _selectors2.default)(_store2.default.getState());
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODO:
      var mergedState = (0, _merge3.default)({}, state, _defineProperty({}, action.todo.id, action.todo));
...
var _todo_list_item = __webpack_require__(172);
  ...
  _createClass(TodoForm, [{
    ...
    value: function submit(e) {
      ...
      this.props.createTodo(todo).then(function () {
        return _this3.setState({ title: '', body: '', done: false });
      });
    }
  }, {
    key: 'render',
